  ...
  <div class="container">
    <form action="{{route("restaurants.store")}}" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control @error("address") is-invalid @enderror" id="address" name="address" placeholder="Scrivi l'indirizzo" value="{{old("address")}}">
        @error("address")
          <div class="alert alert-danger">{{$message}}</div>
        @enderror
      </div>
      ...
      <div class="form-group mb-4">
        ...
        <input type="number" step=".05" class="form-control @error("delivery_price") is-invalid @enderror" id="delivery_price" name="delivery_price" placeholder="Scrivi quanto costa la spedizione" value="{{old("delivery_price")}}">
