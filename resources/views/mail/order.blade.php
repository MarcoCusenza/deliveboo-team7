            ...
            <tr>
                <td>
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-1"
                        role="presentation"
                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff; background-image: url('https://i.postimg.cc/CKknsVXj/Deliver-Boo-2-2x.png'); background-repeat: no-repeat; background-position: 0% 20%; background-size: 250px"
                        width="100%">
                        <tbody>
                            <tr>
                                <td>
                                                        ...
                                                        <tr>
                                                            <td style="width:100%;padding-right:0px;padding-left:0px;">
                                                                <div align="center" style="line-height:10px"><img
                                                                        src="https://i.postimg.cc/43rpZ7Xr/logo-footer.png"
                                                    ...
                                                    <table border="0" cellpadding="25" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h1
                                                                    style="margin: 0; color: #555555; font-size: 23px; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; line-height: 120%; text-align: center; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;">
                                                                    <span class="tinyMce-placeholder">ID Ordine:
                                                                        {{ $order->order_number }}</span></h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <table border="0" cellpadding="25" cellspacing="0"
